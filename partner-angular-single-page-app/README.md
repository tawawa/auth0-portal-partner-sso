...
This sample demonstrates how to add authentication to an Angular application using Portal Partner integration.
...
Update `auth0-variables.ts` and provide the **client ID** and **domain** there. This
file is located in `src/app/auth/`.
